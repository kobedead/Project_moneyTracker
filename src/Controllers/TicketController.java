...
public class TicketController implements Controller<Ticket> {
    ...
    protected CustomIterator ticketCustomIterator;

    protected TicketFactory factory;


    public TicketController(TicketDatabase database , TicketFactory factory, CustomIterator<Person> personCustomIterator, CustomIterator ticketItorator ){
